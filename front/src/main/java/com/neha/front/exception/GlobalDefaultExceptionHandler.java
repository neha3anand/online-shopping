/*
 * package com.neha.front.exception;
 * 
 * 
 * 
 ...
 * handlerNoHandlerFoundException() { ModelAndView mv = new
 * ModelAndView("error");
 * 
 * mv.addObject("errorTitle", "The page is not constructed!"); mv.addObject(
 * "errorDescription","The page you are looking for is not available now!");
 * mv.addObject("title","404 Error Page"); return mv; }
 * 
 * @ExceptionHandler(ProductNotFoundException.class) public ModelAndView
 * handlerProductNotFoundException() {
 * 
